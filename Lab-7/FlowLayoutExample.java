// it afranges tne components in @ tine, one art
...
public class FlowLayoutExample extends Frame {
...

    {
        ...
        // It creates the Frame by calling the ¢
        super(title);

        // Setting up Flow Layout
        setLayout(new FlowLayout());

        // Creating a button and adding it to the
...

    {
        ...
        screen.setSize(400, 150);// sets the width and height of the frame
